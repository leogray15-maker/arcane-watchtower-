...
const PANEL_COL_SPANS_KEY = 'arcane-panel-col-spans';
...
const PANEL_COLLAPSED_KEY = 'arcane-panel-collapsed';
...
export class Panel {
  ...
  public showLocked(features: string[] = []): void {
    ...
    if (isDesktopRuntime()) {
      ctaBtn.addEventListener('click', () => void invokeTauri<void>('open_url', { url: 'https://arcane-watchtower.vercel.app/pro' }).catch(() => window.open('https://arcane-watchtower.vercel.app/pro', '_blank')));
    } else {
