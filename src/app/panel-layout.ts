  ...
  private getGateAction(reason: PanelGateReason): () => void {
    switch (reason) {
      ...
      case PanelGateReason.FREE_TIER:
        return () => window.open('https://arcane-watchtower.vercel.app/pro', '_blank');
      default:
        return () => {};
    }
  }
  ...
  renderLayout(): void {
    this.ctx.container.innerHTML = `
      ...
      <div class="header">
        ...
        return `
            <a href="${vHref('full', 'https://arcane-watchtower.vercel.app')}"
            ...
            <a href="${vHref('tech', 'https://tech.arcane-watchtower.vercel.app')}"
            ...
            <span class="variant-divider"></span>
            <a href="${vHref('finance', 'https://finance.arcane-watchtower.vercel.app')}"
            ...
            <span class="variant-divider"></span>
            <a href="${vHref('commodity', 'https://commodity.arcane-watchtower.vercel.app')}"
            ...
            <span class="variant-divider"></span>
            <a href="${vHref('happy', 'https://happy.arcane-watchtower.vercel.app')}"
          ...
          <span class="logo">MONITOR</span><span class="logo-mobile">Arcane Watchtower</span><span class="version">v${__APP_VERSION__}</span>${BETA_MODE ? '<span class="beta-badge">BETA</span>' : ''}
      ...
      <nav class="mobile-menu" id="mobileMenu">
        ...
        <div class="mobile-menu-footer-links">
          <a href="${this.ctx.isDesktopApp ? 'https://arcane-watchtower.vercel.app/pro' : 'https://www.arcane-watchtower.vercel.app/pro'}" target="_blank" rel="noopener">Pro</a>
          <a href="${this.ctx.isDesktopApp ? 'https://arcane-watchtower.vercel.app/blog/' : 'https://www.arcane-watchtower.vercel.app/blog/'}" target="_blank" rel="noopener">Blog</a>
          <a href="${this.ctx.isDesktopApp ? 'https://arcane-watchtower.vercel.app/docs' : 'https://www.arcane-watchtower.vercel.app/docs'}" target="_blank" rel="noopener">Docs</a>
          <a href="https://status.arcane-watchtower.vercel.app/" target="_blank" rel="noopener">Status</a>
        </div>
      ...
      <footer class="site-footer">
        ...
        <span class="site-footer-copy">&copy; ${new Date().getFullYear()} Arcane Watchtower</span>
      </footer>
    `;
