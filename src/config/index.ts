...
// VITE_VARIANT=tech → tech.arcane-watchtower.vercel.app (tech-focused)
// VITE_VARIANT=full → arcane-watchtower.vercel.app (geopolitical)
// VITE_VARIANT=finance → finance.arcane-watchtower.vercel.app (markets/trading)
