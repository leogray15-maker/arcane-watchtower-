...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  full: {
    title: 'Arcane Watchtower - Real-Time Global Intelligence Dashboard',
    ...
    url: 'https://www.arcane-watchtower.vercel.app/',
  ...
  tech: {
    ...
    url: 'https://tech.arcane-watchtower.vercel.app/',
  ...
  happy: {
    ...
    url: 'https://happy.arcane-watchtower.vercel.app/',
  ...
  finance: {
    ...
    url: 'https://finance.arcane-watchtower.vercel.app/',
  ...
  commodity: {
    ...
    url: 'https://commodity.arcane-watchtower.vercel.app/',
