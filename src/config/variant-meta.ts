...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  full: {
    title: 'Arcane Watchtower — Member Intelligence Terminal',
    description: 'Real-time global intelligence for Arcane Archives members. Markets, geopolitics, conflict zones, and macro signals in one tactical dashboard.',
    keywords: 'intelligence dashboard, geopolitical monitoring, market data, military bases, nuclear facilities, undersea cables, conflict zones, real-time monitoring, trading intelligence, macro signals',
    url: 'https://watchtower.arcanearchives.shop/',
    siteName: 'Arcane Watchtower',
    shortName: 'Watchtower',
    subject: 'Real-Time Intelligence for Arcane Archives Members',
    classification: 'Intelligence Dashboard, Member Terminal',
