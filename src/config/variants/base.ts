...
export const STORAGE_KEYS = {
  panels: 'arcane-panels',
  monitors: 'arcane-monitors',
  mapLayers: 'arcane-layers',
  disabledFeeds: 'arcane-disabled-feeds',
  liveChannels: 'arcane-live-channels',
  mapMode: 'arcane-map-mode',          // 'flat' | 'globe'
  activeChannel: 'arcane-active-channel',
  webcamPrefs: 'arcane-webcam-prefs',
} as const;
