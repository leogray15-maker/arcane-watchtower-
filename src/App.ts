...
export class App {
  ...
  constructor(containerId: string) {
    ...
    const PANEL_SPANS_KEY = 'arcane-panel-spans';
    ...
    const storedVariant = localStorage.getItem('arcane-variant');
    ...
    if (storedVariant !== currentVariant) {
      ...
      localStorage.setItem('arcane-variant', currentVariant);
      ...
      const PANEL_KEY_RENAMES_MIGRATION_KEY = 'arcane-panel-key-renames-v2.6.8';
      ...
      const UNIFIED_MIGRATION_KEY = 'arcane-unified-panels-v1';
      ...
      const HAPPY_PANEL_FIX_KEY = 'arcane-happy-panel-fix-v1';
      ...
      const PANEL_ORDER_MIGRATION_KEY = 'arcane-panel-order-v1.9';
      ...
      if (currentVariant === 'tech') {
        const TECH_INSIGHTS_MIGRATION_KEY = 'arcane-tech-insights-top-v1';
    ...
    const PANEL_PRUNE_KEY = 'arcane-panel-prune-v1';
    ...
    const LAYOUT_RESET_MIGRATION_KEY = 'arcane-layout-reset-v2.5';
    ...
    if (currentVariant === 'full') {
      const baseKey = 'arcane-sources-reduction-v3';
