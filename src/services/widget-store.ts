...
// Cookies with domain=.arcane-watchtower.vercel.app are shared across all subdomains
// (arcane-watchtower.vercel.app, tech., finance., commodity., happy., etc.).
// We read cookie first and fall back to localStorage for migration compat.

const COOKIE_DOMAIN = '.arcane-watchtower.vercel.app';
const KEY_MAX_AGE = 365 * 24 * 60 * 60;

function usesCookies(): boolean {
  return location.hostname.endsWith('arcane-watchtower.vercel.app');
}
