...
export const shareTexts = {
  twitter: (data: StoryData) =>
    ...
    `\nGenerated by @ArcaneWatchtowerApp`,
  ...
  linkedin: (data: StoryData) =>
    ...
    `\nData via Arcane Watchtower - Open source geopolitical intelligence`,
...
export function getShareUrls(data: StoryData): Record<string, string> {
  ...
  return {
    ...
    reddit: `https://reddit.com/submit?url=${encodeURIComponent(url)}&title=${encodeURIComponent(`${data.countryName} Intelligence Brief - Arcane Watchtower`)}`,
